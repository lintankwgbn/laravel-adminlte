...
class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('adminlte.platform', function () {
    ...
    {
        return $this->retrieveUsingCacheOrResolve('adminlte.browser', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('adminlte.desktop', function () {
